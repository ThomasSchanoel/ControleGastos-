...
$sql_alimentacao = "SELECT * FROM bia_compras WHERE categoria = 'alimentacao' ORDER BY data ASC";
$query_alimentacao = $mysqli->query($sql_alimentacao) or die($mysqli->error);
$num_compras = $query_alimentacao->num_rows; 
...
<body>
    <header>
        <h1>Alimentação - R$<?php echo number_format($alimentacao, 2, ',', '.'); ?></h1>
    ...
    <main>
        ...
        <div class="container">
            ...
            <?php else: ?>
                <?php $query_alimentacao->data_seek(0); ?>
                <?php while ($alimentacao = $query_alimentacao->fetch_assoc()): 
