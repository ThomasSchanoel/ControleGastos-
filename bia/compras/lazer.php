...
$sql_lazer = "SELECT * FROM bia_compras WHERE categoria = 'lazer' ORDER BY data ASC";
$query_lazer = $mysqli->query($sql_lazer) or die($mysqli->error);
$num_compras = $query_lazer->num_rows; 
...
<body>
    <header>
        <h1>Lazer - R$<?php echo number_format($lazer, 2, ',', '.'); ?></h1>
    ...
    <main>
        ...
        <div class="container">
            ...
            <?php else: ?>
                <?php $query_lazer->data_seek(0); ?>
                <?php while ($compra = $query_lazer->fetch_assoc()): 
