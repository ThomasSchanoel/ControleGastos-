...
$sql_debito = "SELECT * FROM thomas_compras WHERE pagamento = 'debito' ORDER BY data ASC";
$query_debito = $mysqli->query($sql_debito) or die($mysqli->error);
$num_compras = $query_debito->num_rows; 
...
<head>
    ...
    <title>Total Débito</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <div class="container">
        <div class="header">
            <h1 class="header-title">Débito</h1>
            ...
            <ul class="transaction-list">
                ...
                <li class="transaction">
                    <div class="transaction-details">
                        ...
                        <p class="transaction-subtitle">Débito | <?php echo htmlspecialchars(date('d/m/Y', strtotime($compra['data']))); ?></p>
                    </div>
