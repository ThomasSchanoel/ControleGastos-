...
$sql_credito = "SELECT * FROM thomas_compras WHERE pagamento = 'credito' || pagamento = 'debito' || pagamento = 'creditoB' ORDER BY data ASC";
...
<body>
    <div class="container">
        <div class="header">
            <h1 class="header-title">Crédito e Débito</h1>
